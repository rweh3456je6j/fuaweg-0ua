...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : Germany Server`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : Germany Server ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`$bc |Germany Server`,"http://twitch.tv/Germany Shop")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/5k2XY2q
            **`);
